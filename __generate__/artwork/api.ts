 ...
 * @export
 */
export const ArtworkControllerApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    createArtwork1: async (
      id: number,
      createArtworkBatchRequestDto: CreateArtworkBatchRequestDto,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      ...
      assertParamExists(
        "createArtwork1",
        "createArtworkBatchRequestDto",
        createArtworkBatchRequestDto
      );
      const localVarPath = `/artwork/batch/{id}`.replace(
        `{${"id"}}`,
    ...
    deleteArtwork: async (
      ...
      const localVarPath = `/artwork/{id}`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getArtworkBrowseThumbnails: async (
      id: number,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("getArtworkBrowseThumbnails", "id", id);
      const localVarPath = `/artwork/post/{id}/thumbnail`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getArtworkPageFromPost: async (
      ...
      const localVarPath = `/artwork/post/{id}`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    setMainArtwork: async (
      id: number,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("setMainArtwork", "id", id);
      const localVarPath = `/artwork/main/{id}`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const ArtworkControllerApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    ArtworkControllerApiAxiosParamCreator(configuration);
  return {
    /**
     * 작품(이미지)를 전시에 추가
     * @summary 전시 작품 추가
    ...
    async createArtwork(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<CreateArtworkResponseDto>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createArtwork(
        createArtworkRequestDto,
        options
      );
    ...
    async createArtwork1(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<CreateArtworkBatchResponseDto>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createArtwork1(
        id,
        createArtworkBatchRequestDto,
        options
      );
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteArtwork(
        id,
        options
      );
      return createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async getArtworkBrowseThumbnails(
      id: number,
      options?: AxiosRequestConfig
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<Array<ArtworkBrowseThumbnailDto>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getArtworkBrowseThumbnails(id, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    async getArtworkInfo(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ArtworkInfoDto>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getArtworkInfo(
        id,
        options
      );
      return createRequestFunction(
    ...
    async getArtworkPageFromPost(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ArtworkThumbnailDtoPage>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getArtworkPageFromPost(
          id,
          size,
          page,
          direction,
     ...
     * @throws {RequiredError}
     */
    async setMainArtwork(
      id: number,
      options?: AxiosRequestConfig
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.setMainArtwork(
        id,
        options
      );
      return createRequestFunction(
    ...
    async updateArtwork(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateArtwork(
        id,
        updateArtworkRequestDto,
        options
      );
 ...
 * @export
 */
export const ArtworkControllerApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
    ...
    createArtwork(
      ...
      return localVarFp
        .createArtwork(createArtworkRequestDto, options)
    ...
    createArtwork1(
      ...
      return localVarFp
        .createArtwork1(id, createArtworkBatchRequestDto, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    getArtworkBrowseThumbnails(
      id: number,
      options?: any
    ): AxiosPromise<Array<ArtworkBrowseThumbnailDto>> {
      return localVarFp
        .getArtworkBrowseThumbnails(id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * 작품 상세 페이지의 작품 상세 정보 조회
    ...
    getArtworkPageFromPost(
      ...
      return localVarFp
        .getArtworkPageFromPost(id, size, page, direction, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * 해당 작품을 해당 전시의 대표 작품으로 설정. 기존 작품은 대표 작품에서 해제됨
    ...
    updateArtwork(
      ...
      return localVarFp
        .updateArtwork(id, updateArtworkRequestDto, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class ArtworkControllerApi extends BaseAPI {
  ...
  public createArtwork(
    ...
    return ArtworkControllerApiFp(this.configuration)
      .createArtwork(createArtworkRequestDto, options)
